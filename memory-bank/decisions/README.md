...
Architecture Decision Records (ADRs). Document significant technical choices and their rationale.
...
| `04_agentfs_vector_memory.md` | AgentFS local SQLite + Ollama vector embeddings for memory-bank |
